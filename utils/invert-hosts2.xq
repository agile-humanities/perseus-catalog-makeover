...
return
...

    {
        ...
        return
            if ($part) then
            <relatedItem xmlns="http://www.loc.gov/mods/v3" type='constituent' otherType='structure' displayLabel="{normalize-space($part[1])}">
                <part type='volume'>
                    <detail type='volume'>
               ...
               for $c in $h
                ...
                return 
                      ...
                      else () }
                    {
                        ...
                        return
                        <mods:relatedItem type='constituent' otherType='expression' displayLabel="{$m-title}">
                        { if ($m-urn) then
                             <mods:identifier type='ctsurn'>{$m-urn}</mods:identifier>
                          else () }
                        </mods:relatedItem>
                    }
                    </mods:relatedItem>
